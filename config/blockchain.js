...
const EmeraldCertificateABI = require("../contracts/artifacts/contracts/EmeraldCertificate.sol/EmeraldCertificate.json").abi;
const GlazeMarketABI = require("../contracts/artifacts/contracts/GlazeMarket.sol/GlazeMarket.json").abi;
